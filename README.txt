...
1. This package includes the version of Pygame that is necessary for running with PyMOL versions based in python 2.5.
	Users running PyMOL based in python 2.5 can perform the subsequent step using the provided copy of PyGame.
2. After obtaining the Pygame files, place the Pygame folder directly into "./py25/Lib/site-packages" within the home directory for your PyMOL program
